...
class AssociationUtils:
    ...
    def _local_mk_kinship(self):
        ...
        kin_cmd = ['emmax-kin', '-v', '-d', '10', '-M', '1.0', self.local_kinship_prefix]
        ...
        self.local_kinship_file = os.path.join(self.local_data_dir,'output',self.local_kinship_prefix+'.aBN.kinf')
